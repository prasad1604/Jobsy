...
public class ProfileServiceImpl implements ProfileService{
    ...
    public void sendResetOtp(String email) {
        ...
        try{
            emailService.sendResetOtpEmail(existingEntity.getEmail(), otp, existingEntity.getName());
        }
        catch(Exception ex){
    ...
    public void sendOtp(String email) {
        ...
        existingUser.setVeriftOtpExpireAt(expiryTime);
    ...
    public void verifyOtp(String email, String otp) {
        ...
        if(existingUser.getVeriftOtpExpireAt() < System.currentTimeMillis()){
            throw new RuntimeException("OTP has expired");
        }

        existingUser.setIsAccountVerified(true);
        existingUser.setVerifyOtp(null);
        existingUser.setVeriftOtpExpireAt(0L);
