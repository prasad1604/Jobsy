      ...
      {!isEmailSent && (
        ...
        >
          ...
          <form onSubmit={onSubmitEmail}>
            <div className="input-group mb-4 bg-secondary bg-oapacity-10 rounded-pill">
        ...
        >
          ...
          <form onSubmit={onSubmitNewPassword}>
            <div className="input-group mb-4 bg-secondary bg-opacity-10 rounded pill">
              ...
              <input
                type="password"
                className="form-control bg-transparent border-0 ps-1 pe-1 rounded-end"
                placeholder="*********"
                style={{ height: "50px" }}
